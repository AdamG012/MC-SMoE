...
DATASET_PATH="/workdir/datasets/winogrande-winogrande_l";
METRIC_PATH="/workdir/metrics/winogrande"
...
accelerate launch --config_file static/finetune_multi_gpu_2.yaml \
